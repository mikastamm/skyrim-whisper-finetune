...
add_arg("model_path",  type=str, default="output/whisper-tiny", help="合并模型的路径，或者是huggingface上模型的名称")
add_arg("batch_size",  type=int, default=24,        help="评估的batch size")
...
add_arg("metric",     type=str, default="cer",        choices=['cer', 'wer', 'skyrim'],              help="评估方式")
